...
- [工具](#94ca60d12e210fdd7fd9e387339b293e)
    ...
    - [数据库&&SQL攻击&&SQL注入](#969212c047f97652ceb9c789e4d8dae5)
        - [(7) 未分类-Database](#e8d5cfc417b84fa90eff2e02c3231ed1)
...
- [**261**星][1y] [PS] [fox-it/invoke-aclpwn](https://github.com/fox-it/invoke-aclpwn) 
...
- [**226**星][2m] [PS] [miriamxyra/eventlist](https://github.com/miriamxyra/eventlist) help improving your Audit capabilities and to help to build your Security Operation Center.
...
- [**676**星][12d] [XSLT] [adon90/pentest_compilation](https://github.com/adon90/pentest_compilation) Compilation of commands, tips and scripts that helped me throughout Vulnhub, Hackthebox, OSCP and real scenarios
...
- [**574**星][22d] [PS] [threatexpress/red-team-scripts](https://github.com/threatexpress/red-team-scripts) A collection of Red Team focused tools, scripts, and notes
...
- [**608**星][7m] [JS] [vincentcox/stacoan](https://github.com/vincentcox/stacoan) StaCoAn is a crossplatform tool which aids developers, bugbounty hunters and ethical hackers performing static code analysis on mobile applications.
    - 重复区段: [工具->漏洞->审计->未分类-Audit](#6a5e7dd060e57d9fdb3fed8635d61bc7) |
- [**544**星][11d] [Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) OWASP 移动App安全标准
...
- [**2103**星][8m] [Py] [linkedin/qark](https://github.com/linkedin/qark) 查找Android App的漏洞, 支持源码或APK文件
    - 重复区段: [工具->漏洞->漏洞扫描->漏洞扫描->未分类](#0ed7e90d216a8a5be1dafebaf9eaeb5d) |
...
- [**789**星][2m] [sh4hin/androl4b](https://github.com/sh4hin/androl4b) 用于评估Android应用程序，逆向工程和恶意软件分析的虚拟机
    - 重复区段: [工具->环境配置->未分类-Env](#f5a7a43f964b2c50825f3e2fee5078c8) |
...
- [**518**星][4m] [JS] [wooyundota/droidsslunpinning](https://github.com/wooyundota/droidsslunpinning) Android certificate pinning disable tools
...
- [**348**星][10d] [TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) 
    - 重复区段: [工具->浏览嗅探->未分类-Network](#99398a5a8aaf99228829dadff48fb6a7) |[工具->浏览嗅探->中间人](#11c73d3e2f71f3914a3bca35ba90de36) |
...
- [**4190**星][7m] [ObjC] [alonemonkey/monkeydev](https://github.com/alonemonkey/monkeydev) CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps, Without Jailbreak.
...
- [**1413**星][7m] [ObjC] [nabla-c0d3/ssl-kill-switch2](https://github.com/nabla-c0d3/ssl-kill-switch2) Blackbox tool to disable SSL certificate validation - including certificate pinning - within iOS and OS X Apps
...
- [**1098**星][1y] [ObjC] [neoneggplant/eggshell](https://github.com/neoneggplant/eggshell) iOS/macOS/Linux Remote Administration Tool
...
- [**642**星][9m] [ObjC] [chenxiancai/stcobfuscator](https://github.com/chenxiancai/stcobfuscator) iOS全局自动化 代码混淆 工具！支持cocoapod组件代码一并 混淆，完美避开hardcode方法、静态库方法和系统库方法！
...
- [**205**星][9d] [TS] [bevry/getmac](https://github.com/bevry/getmac) Get the mac address of the current machine you are on via Node.js
...
- [**368**星][5m] [xtiankisutsa/awesome-mobile-ctf](https://github.com/xtiankisutsa/awesome-mobile-ctf) This is a curated list of mobile based CTFs, write-ups and vulnerable apps. Most of them are android based due to the popularity of the platform.
    - 重复区段: [工具->靶机->收集](#383ad9174d3f7399660d36cd6e0b2c00) |
...
- [**1151**星][13d] [Py] [p4-team/ctf](https://github.com/p4-team/ctf) Ctf solutions from p4 team
...
- [**395**星][10d] [Py] [moloch--/rootthebox](https://github.com/moloch--/rootthebox) A Game of Hackers (CTF Scoreboard & Game Manager)
...
- [**1844**星][8d] [TS] [snyk/snyk](https://github.com/snyk/snyk) CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies
...
- [**1093**星][1y] [PS] [rasta-mouse/sherlock](https://github.com/rasta-mouse/sherlock) PowerShell script to quickly find missing software patches for local privilege escalation vulnerabilities.
...
- [**546**星][1y] [Java] [mr5m1th/poc-collect](https://github.com/Mr5m1th/POC-Collect) 各种开源CMS 各种版本的漏洞以及EXP 该项目将不断更新
...
- [**308**星][13d] [Py] [ym2011/poc-exp](https://github.com/ym2011/poc-exp) Collecting and writing PoC or EXP for vulnerabilities on some application
...
- [**2204**星][10d] [PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
- [**1198**星][24d] [Py] [thekingofduck/fuzzdicts](https://github.com/thekingofduck/fuzzdicts) Web Pentesting Fuzz 字典,一个就够了。
    - 重复区段: [工具->漏洞->漏洞扫描->Fuzzing->未分类-Fuzz](#1c2903ee7afb903ccfaa26f766924385) |
- [**1097**星][5m] [Py] [coffeehb/some-poc-or-exp](https://github.com/coffeehb/some-poc-or-exp) 各种漏洞poc、Exp的收集或编写
- [**1063**星][15d] [Py] [offensive-security/exploitdb-bin-sploits](https://github.com/offensive-security/exploitdb-bin-sploits) Exploit Database binary exploits located in the /sploits directory
...
- [**2936**星][1m] [Py] [andresriancho/w3af](https://github.com/andresriancho/w3af) Web App安全扫描器, 辅助开发者和渗透测试人员识别和利用Web App中的漏洞
    - 重复区段: [工具->扫描器->未分类-Scanner](#de63a029bda6a7e429af272f291bb769) |
...
- [**2103**星][8m] [Py] [linkedin/qark](https://github.com/linkedin/qark) 查找Android App的漏洞, 支持源码或APK文件
    - 重复区段: [工具->移动->Android](#fe88ee8c0df10870b44c2dedcd86d3d3) |
- [**1909**星][9d] [Py] [j3ssie/osmedeus](https://github.com/j3ssie/osmedeus) Fully automated offensive security framework for reconnaissance and vulnerability scanning
    - 重复区段: [工具->侦察->信息收集](#375a8baa06f24de1b67398c1ac74ed24) |
...
- [**726**星][10m] [PS] [l0ss/grouper](https://github.com/l0ss/grouper) A PowerShell script for helping to find vulnerable settings in AD Group Policy. (deprecated, use Grouper2 instead!)
...
- [**550**星][3m] [Py] [hatboy/struts2-scan](https://github.com/hatboy/struts2-scan) Struts2全漏洞扫描利用工具
- [**542**星][5m] [JS] [seccubus/seccubus](https://github.com/seccubus/seccubus) Easy automated vulnerability scanning, reporting and analysis
- [**533**星][8m] [Py] [wyatu/perun](https://github.com/wyatu/perun) 主要适用于乙方安服、渗透测试人员和甲方RedTeam红队人员的网络资产漏洞扫描器/扫描框架
...
- [**4771**星][8d] [C] [google/oss-fuzz](https://github.com/google/oss-fuzz) 开源软件fuzzing
...
- [**1722**星][1y] [PS] [fuzzysecurity/powershell-suite](https://github.com/fuzzysecurity/powershell-suite) My musings with PowerShell
...
- [**1198**星][24d] [Py] [thekingofduck/fuzzdicts](https://github.com/thekingofduck/fuzzdicts) Web Pentesting Fuzz 字典,一个就够了。
    - 重复区段: [工具->漏洞->资源收集](#750f4c05b5ab059ce4405f450b56d720) |
...
- [**543**星][8m] [Py] [shellphish/fuzzer](https://github.com/shellphish/fuzzer) Americanfuzzy lop 的 Python 版本接口
- [**520**星][3m] [C++] [angorafuzzer/angora](https://github.com/angorafuzzer/angora) Angora is a mutation-based fuzzer. The main goal of Angora is to increase branch coverage by solving path constraints without symbolic execution.
...
- [**436**星][19d] [TS] [fuzzitdev/jsfuzz](https://github.com/fuzzitdev/jsfuzz) coverage guided fuzz testing for javascript
...
- [**1203**星][30d] [Py] [codingo/nosqlmap](https://github.com/codingo/NoSQLMap) Automated NoSQL database enumeration and web application exploitation tool.
    - 重复区段: [工具->侦察->未分类-OSINT](#05ab1b75266fddafc7195f5b395e4d99) |[工具->数据库->NoSQL->未分类-NoSQL](#af0aaaf233cdff3a88d04556dc5871e0) |
...
- [**518**星][9m] [Py] [dark-lbp/isf](https://github.com/dark-lbp/isf) 工控漏洞利用框架，基于Python
...
- [**615**星][3m] [C] [matheus-garbelini/esp32_esp8266_attacks](https://github.com/matheus-garbelini/esp32_esp8266_attacks) Proof of Concept of ESP32/8266 Wi-Fi vulnerabilties (CVE-2019-12586, CVE-2019-12587, CVE-2019-12588)
    - 重复区段: [工具->渗透->无线->未分类-WiFi](#d4efda1853b2cb0909727188116a2a8c) |
...
- [**554**星][10m] [C] [t00sh/rop-tool](https://github.com/t00sh/rop-tool) binary exploits编写辅助脚本
- [**528**星][6m] [Py] [bignerd95/chimay-red](https://github.com/bignerd95/chimay-red) Working POC of Mikrotik exploit from Vault 7 CIA Leaks
...
- [**306**星][3m] [PS] [kevin-robertson/powermad](https://github.com/kevin-robertson/powermad) PowerShell MachineAccountQuota and DNS exploit tools
...
- [**221**星][4m] [PS] [byt3bl33d3r/offensivedlr](https://github.com/byt3bl33d3r/offensivedlr) Toolbox containing research notes & PoC code for weaponizing .NET's DLR
...
- [**516**星][5m] [Py] [opensec-cn/vtest](https://github.com/opensec-cn/vtest) 用于辅助安全工程师漏洞挖掘、测试、复现，集合了mock、httplog、dns tools、xss，可用于测试各类无回显、无法直观判断或特定场景下的漏洞。
...
- [**559**星][11m] [Py] [fs0c131y/esfileexploreropenportvuln](https://github.com/fs0c131y/esfileexploreropenportvuln) ES File Explorer Open Port Vulnerability - CVE-2019-6447
...
### <a id="7b8f94c7c99dfef6f57fa887769446e5"></a>CMS


#### <a id="fdf50b8f928697534bc6aab0682f963c"></a>未分类-CMS




#### <a id="f0b123d77c3e667a617e9eac8499fb7a"></a>Wordpress




#### <a id="de47e7aff3b31a99b1c4bdc7d7636cce"></a>ROR
...
- [**6449**星][12d] [Shell] [cisofy/lynis](https://github.com/cisofy/lynis) Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening. Agentless, and installation optional.
...
- [**608**星][7m] [JS] [vincentcox/stacoan](https://github.com/vincentcox/stacoan) StaCoAn is a crossplatform tool which aids developers, bugbounty hunters and ethical hackers performing static code analysis on mobile applications.
    - 重复区段: [工具->移动->未分类-Mobile](#4a64f5e8fdbd531a8c95d94b28c6c2c1) |
...
- [**239**星][4m] [PS] [nccgroup/azucar](https://github.com/nccgroup/azucar) Azure环境安全审计工具
- [**215**星][1y] [C] [meliot/filewatcher](https://github.com/meliot/filewatcher) A simple auditing utility for macOS


#### <a id="a5bce67a604f59eb3287e322e9a87516"></a>Java




#### <a id="8e4024858576dbafe1a9cd7d0653c5cf"></a>PHP
...
- [**3225**星][19d] [Shell] [toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) List of open source tools for AWS security: defensive, offensive, auditing, DFIR, etc.
...
- [**1876**星][8d] [Shell] [toniblyx/prowler](https://github.com/toniblyx/prowler) AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool. It follows guidelines of the CIS Amazon Web Services Foundations Benchmark and DOZENS of additional checks including GDPR and HIPAA (+100). Official CIS for AWS guide:
...
- [**835**星][14d] [Py] [jordanpotti/awsbucketdump](https://github.com/jordanpotti/awsbucketdump) 快速枚举 AWS S3 Buckets，查找感兴趣的文件。类似于子域名爆破，但针对S3 Bucket，有额外功能，例如下载文件等
...
- [**778**星][11d] [Go] [rebuy-de/aws-nuke](https://github.com/rebuy-de/aws-nuke) Nuke a whole AWS account and delete all its resources.
...
- [**559**星][2m] [Shell] [denizparlak/zeus](https://github.com/denizparlak/zeus) AWS Auditing & Hardening Tool
- [**532**星][8d] [Py] [salesforce/policy_sentry](https://github.com/salesforce/policy_sentry) IAM Least Privilege Policy Generator
- [**531**星][10d] [Ruby] [stelligent/cfn_nag](https://github.com/stelligent/cfn_nag) Linting tool for CloudFormation templates
...
- [**285**星][1y] [Py] [nccgroup/aws-inventory](https://github.com/nccgroup/aws-inventory) 发现在AWS账户中创建的资源
...
- [**16951**星][14d] [Py] [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - 重复区段: [工具->浏览嗅探->中间人](#11c73d3e2f71f3914a3bca35ba90de36) |
...
- [**1204**星][7d] [ObjC] [onionbrowser/onionbrowser](https://github.com/onionbrowser/onionbrowser) An open-source, privacy-enhancing web browser for iOS, utilizing the Tor anonymity network
...
- [**559**星][9m] [JS] [blinksocks/blinksocks](https://github.com/blinksocks/blinksocks) A framework for building composable proxy protocol stack.
- [**559**星][1y] [Py] [fate0/getproxy](https://github.com/fate0/getproxy) 是一个抓取发放代理网站，获取 http/https 代理的程序
- [**515**星][11m] [Erlang] [heroku/vegur](https://github.com/heroku/vegur) HTTP Proxy Library
...
- [**554**星][1y] [Go] [cw1997/natbypass](https://github.com/cw1997/natbypass) 内网穿透，端口转发工具
...
- [**1397**星][8d] [Rust] [shadowsocks/shadowsocks-rust](https://github.com/shadowsocks/shadowsocks-rust) A Rust port of shadowsocks
...
- [**521**星][9m] [JS] [mrluanma/shadowsocks-heroku](https://github.com/mrluanma/shadowsocks-heroku) shadowsocks over WebSocket, support Heroku.
- [**499**星][2m] [JS] [shadowsocks/shadowsocks-org](https://github.com/shadowsocks/shadowsocks-org) 
- [**422**星][3m] [PS] [p3nt4/invoke-socksproxy](https://github.com/p3nt4/invoke-socksproxy) Socks proxy server using powershell. Supports local and reverse connections for pivoting.
...
- [**558**星][11d] [C++] [lhy0403/qv2ray](https://github.com/lhy0403/qv2ray) 跨平台 (Windows linux macOS) v2ray GUI, 使用 Qt & c++， 支持 vmess ss socks，支持导入文件，vmess://， 二维码扫描，支持连接编辑，路由编辑，附带 Windows/Plasma 工具栏 Telegram:
...
- [**2036**星][2m] [C++] [lordnoteworthy/al-khaser](https://github.com/lordnoteworthy/al-khaser) Public malware techniques used in the wild: Virtual Machine, Emulation, Debuggers, Sandbox detection.
    - 重复区段: [工具->恶意代码](#8cb1c42a29fa3e8825a0f8fca780c481) |
...
- [**961**星][19d] [C] [bt3gl/pentesting-toolkit](https://github.com/bt3gl/Pentesting-Toolkit) Tools for pentesting, CTFs & wargames.
    - 重复区段: [工具->CTF->收集](#30c4df38bcd1abaaaac13ffda7d206c6) |
...
- [**796**星][21d] [Py] [jivoi/pentest](https://github.com/jivoi/pentest) 
...
- [**563**星][22d] [Ruby] [hackplayers/evil-winrm](https://github.com/hackplayers/evil-winrm) The ultimate WinRM shell for hacking/pentesting
...
- [**503**星][13d] [PS] [s3cur3th1ssh1t/winpwn](https://github.com/S3cur3Th1sSh1t/WinPwn) Automation for internal Windows Penetrationtest / AD-Security
- [**494**星][27d] [netbiosx/checklists](https://github.com/netbiosx/checklists) Pentesting checklists for various engagements
...
- [**393**星][4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) Most usable tools for iOS penetration testing
    - 重复区段: [工具->移动->iOS](#dbde77352aac39ee710d3150a921bcad) |
...
- [**390**星][10d] [PS] [d0nkeys/redteam](https://github.com/d0nkeys/redteam) Red Team Scripts by d0nkeys (ex SnadoTeam)
...
- [**347**星][1y] [PS] [rootclay/powershell-attack-guide](https://github.com/rootclay/powershell-attack-guide) Powershell攻击指南----黑客后渗透之道
...
- [**321**星][3m] [PS] [kmkz/pentesting](https://github.com/kmkz/pentesting) Tricks for penetration testing
...
- [**303**星][3m] [Ruby] [fozavci/viproy-voipkit](https://github.com/fozavci/viproy-voipkit) VoIP渗透测试工具和 Metasploit 框架
    - 重复区段: [工具->渗透->Metasploit->未分类-metasploit](#01be61d5bb9f6f7199208ff0fba86b5d) |
- [**294**星][2m] [Py] [bishopfox/eyeballer](https://github.com/bishopfox/eyeballer) 用于大型网络渗透测试中需要从大量基于Web的主机中找到“有趣的”目标
    - 重复区段: [工具->人工智能->未分类-AI](#19dd474da6b715024ff44d27484d528a) |
...
- [**245**星][1m] [PS] [sdcampbell/internal-pentest-playbook](https://github.com/sdcampbell/internal-pentest-playbook) Internal Network Penetration Test Playbook
...
- [**537**星][7m] [Py] [0xdea/tactical-exploitation](https://github.com/0xdea/tactical-exploitation) 渗透测试辅助工具包. Python/PowerShell脚本
...
- [**2851**星][11d] [JS] [evilsocket/pwnagotchi](https://github.com/evilsocket/pwnagotchi) 深度学习+Bettercap，基于A2C，从周围的WiFi环境中学习，以最大程度地利用捕获的WPA关键信息
    - 重复区段: [工具->人工智能->未分类-AI](#19dd474da6b715024ff44d27484d528a) |[工具->浏览嗅探->中间人](#11c73d3e2f71f3914a3bca35ba90de36) |
...
- [**1832**星][4m] [Shell] [arismelachroinos/lscript](https://github.com/arismelachroinos/lscript) 自动化无线渗透和Hacking 任务的脚本
    - 重复区段: [工具->渗透->自动化](#fc8737aef0f59c3952d11749fe582dac) |
...
- [**798**星][1y] [ObjC] [igrsoft/kismac2](https://github.com/igrsoft/kismac2) KisMAC is a free, open source wireless stumbling and security tool for Mac OS X.
...
- [**680**星][10m] [ObjC] [unixpickle/jamwifi](https://github.com/unixpickle/jamwifi) A GUI, easy to use WiFi network jammer for Mac OS X
...
- [**615**星][3m] [C] [matheus-garbelini/esp32_esp8266_attacks](https://github.com/matheus-garbelini/esp32_esp8266_attacks) Proof of Concept of ESP32/8266 Wi-Fi vulnerabilties (CVE-2019-12586, CVE-2019-12587, CVE-2019-12588)
    - 重复区段: [工具->漏洞->漏洞利用->Exp](#5c1af335b32e43dba993fceb66c470bc) |
- [**515**星][12d] [C++] [cyberman54/esp32-paxcounter](https://github.com/cyberman54/esp32-paxcounter) Wifi & BLE driven passenger flow metering with cheap ESP32 boards
...
- [**256**星][1m] [Py] [ghostop14/sparrow-wifi](https://github.com/ghostop14/sparrow-wifi) Next-Gen GUI-based WiFi and Bluetooth Analyzer for Linux
    - 重复区段: [工具->蓝牙](#ceb90405292daed9bb32ac20836c219a) |[工具->浏览嗅探->未分类-Network](#99398a5a8aaf99228829dadff48fb6a7) |
...
- [**218**星][1m] [PS] [rsmudge/elevatekit](https://github.com/rsmudge/elevatekit) The Elevate Kit demonstrates how to use third-party privilege escalation attacks with Cobalt Strike's Beacon payload.
...
- [**3316**星][2m] [C] [screetsec/thefatrat](https://github.com/screetsec/thefatrat) Thefatrat a massive exploiting tool : Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack and etc . This tool compiles a malware with popular payload and then the compiled malware can be execute on windows, android, mac . The malware that created with this tool also have an ability to bypass most AV softw…
    - 重复区段: [工具->渗透->后渗透->未分类-post-exp](#12abc279c69d1fcf10692b9cb89bcdf7) |
...
- [**1768**星][13d] [Shell] [leebaird/discover](https://github.com/leebaird/discover) 自定义的bash脚本, 用于自动化多个渗透测试任务, 包括: 侦查、扫描、解析、在Metasploit中创建恶意Payload和Listener
    - 重复区段: [工具->渗透->自动化](#fc8737aef0f59c3952d11749fe582dac) |[工具->侦察->未分类-OSINT](#05ab1b75266fddafc7195f5b395e4d99) |[工具->渗透->Metasploit->未分类-metasploit](#01be61d5bb9f6f7199208ff0fba86b5d) |
- [**1310**星][3m] [PS] [peewpw/invoke-psimage](https://github.com/peewpw/invoke-psimage) Encodes a PowerShell script in the pixels of a PNG file and generates a oneliner to execute
...
- [**3598**星][8d] [TS] [javascript-obfuscator/javascript-obfuscator](https://github.com/javascript-obfuscator/javascript-obfuscator) A powerful obfuscator for JavaScript and Node.js
- [**2453**星][11m] [C#] [yck1509/confuserex](https://github.com/yck1509/confuserex) An open-source, free protector for .NET applications
- [**1365**星][9m] [PS] [danielbohannon/invoke-obfuscation](https://github.com/danielbohannon/invoke-obfuscation) PowerShell Obfuscator
- [**1136**星][7m] [hikariobfuscator/hikari](https://github.com/HikariObfuscator/Hikari) LLVM Obfuscator
- [**984**星][23d] [Swift] [rockbruno/swiftshield](https://github.com/rockbruno/swiftshield) wift/OBJ-C Obfuscator
...
- [**271**星][8d] [TS] [javascript-obfuscator/webpack-obfuscator](https://github.com/javascript-obfuscator/webpack-obfuscator) javascript-obfuscator plugin for Webpack
...
- [**5023**星][4m] [PS] [empireproject/empire](https://github.com/EmpireProject/Empire) 后渗透框架. Windows客户端用PowerShell, Linux/OSX用Python. 之前PowerShell Empire和Python EmPyre的组合
...
- [**3383**星][22d] [PS] [samratashok/nishang](https://github.com/samratashok/nishang) 渗透框架，脚本和Payload收集，主要是PowerShell，涵盖渗透的各个阶段
...
- [**2404**星][24d] [Py] [infobyte/faraday](https://github.com/infobyte/faraday) 渗透测试和漏洞管理平台
    - 重复区段: [工具->漏洞->漏洞管理](#9f068ea97c2e8865fac21d6fc50f86b3) |
...
- [**6956**星][10d] [C] [hashcat/hashcat](https://github.com/hashcat/hashcat) 世界上最快最先进的密码恢复工具
    - 重复区段: [工具->密码->密码](#86dc226ae8a71db10e4136f4b82ccd06) |
- [**3316**星][2m] [C] [screetsec/thefatrat](https://github.com/screetsec/thefatrat) Thefatrat a massive exploiting tool : Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack and etc . This tool compiles a malware with popular payload and then the compiled malware can be execute on windows, android, mac . The malware that created with this tool also have an ability to bypass most AV softw…
    - 重复区段: [工具->渗透->Payload->Payload生成](#ad92f6b801a18934f1971e2512f5ae4f) |
...
- [**738**星][5m] [PS] [hausec/adape-script](https://github.com/hausec/adape-script) Active Directory Assessment and Privilege Escalation Script
...
- [**536**星][5m] [rhinosecuritylabs/aws-iam-privilege-escalation](https://github.com/rhinosecuritylabs/aws-iam-privilege-escalation) A centralized source of all AWS IAM privilege escalation methods released by Rhino Security Labs.
...
- [**386**星][3m] [PS] [cyberark/aclight](https://github.com/cyberark/ACLight) A script for advanced discovery of Privileged Accounts - includes Shadow Admins
- [**363**星][2m] [PS] [gdedrouas/exchange-ad-privesc](https://github.com/gdedrouas/exchange-ad-privesc) Exchange privilege escalations to Active Directory
...
- [**515**星][11m] [PS] [a-min3/winspect](https://github.com/a-min3/winspect) Powershell-based Windows Security Auditing Toolbox
...
- [**297**星][1y] [PS] [onelogicalmyth/zeroday-powershell](https://github.com/onelogicalmyth/zeroday-powershell) A PowerShell example of the Windows zero day priv esc
...
- [**3587**星][2m] [PS] [bloodhoundad/bloodhound](https://github.com/BloodHoundAD/BloodHound) a single page Javascript web application, uses graph theory to reveal the hidden and often unintended relationships within an Active Directory environment.
...
- [**1832**星][4m] [Shell] [arismelachroinos/lscript](https://github.com/arismelachroinos/lscript) 自动化无线渗透和Hacking 任务的脚本
    - 重复区段: [工具->渗透->无线->未分类-WiFi](#d4efda1853b2cb0909727188116a2a8c) |
- [**1768**星][13d] [Shell] [leebaird/discover](https://github.com/leebaird/discover) 自定义的bash脚本, 用于自动化多个渗透测试任务, 包括: 侦查、扫描、解析、在Metasploit中创建恶意Payload和Listener
    - 重复区段: [工具->侦察->未分类-OSINT](#05ab1b75266fddafc7195f5b395e4d99) |[工具->渗透->Payload->Payload生成](#ad92f6b801a18934f1971e2512f5ae4f) |[工具->渗透->Metasploit->未分类-metasploit](#01be61d5bb9f6f7199208ff0fba86b5d) |
...
- [**352**星][12d] [Kotlin] [portswigger/turbo-intruder](https://github.com/portswigger/turbo-intruder) Turbo Intruder is a Burp Suite extension for sending large numbers of HTTP requests and analyzing the results.
- [**327**星][12d] [Java] [portswigger/http-request-smuggler](https://github.com/PortSwigger/http-request-smuggler) an extension for Burp Suite designed to help you launch HTTP Request Smuggling attack
...
- [**241**星][18d] [Java] [c0ny1/jsencrypter](https://github.com/c0ny1/jsencrypter) 一个用于加密传输爆破的Burp Suite插件
...
- [**204**星][6m] [Perl] [modzero/mod0burpuploadscanner](https://github.com/modzero/mod0burpuploadscanner) HTTP file upload scanner for Burp Proxy
...
- [**1768**星][13d] [Shell] [leebaird/discover](https://github.com/leebaird/discover) 自定义的bash脚本, 用于自动化多个渗透测试任务, 包括: 侦查、扫描、解析、在Metasploit中创建恶意Payload和Listener
    - 重复区段: [工具->渗透->自动化](#fc8737aef0f59c3952d11749fe582dac) |[工具->侦察->未分类-OSINT](#05ab1b75266fddafc7195f5b395e4d99) |[工具->渗透->Payload->Payload生成](#ad92f6b801a18934f1971e2512f5ae4f) |
...
- [**263**星][7d] [PS] [nettitude/poshc2](https://github.com/nettitude/poshc2) Python Server for PoshC2
- [**263**星][7d] [PS] [nettitude/poshc2](https://github.com/nettitude/PoshC2) Python Server for PoshC2
...
- [**851**星][3m] [Py] [649/memcrashed-ddos-exploit](https://github.com/649/memcrashed-ddos-exploit) DDoS attack tool for sending forged UDP packets to vulnerable Memcached servers obtained using Shodan API
    - 重复区段: [工具->侦察->Shodan](#18c7c1df2e6ae5e9135dfa2e4eb1d4db) |
...
- [**547**星][2m] [Shell] [offensive-security/kali-linux-docker](https://github.com/offensive-security/kali-linux-docker) PLEASE USE GITLAB
...
- [**211**星][9m] [PS] [outflanknl/excel4-dcom](https://github.com/outflanknl/excel4-dcom) PowerShell and Cobalt Strike scripts for lateral movement using Excel 4.0 / XLM macros via DCOM (direct shellcode injection in Excel.exe)
...
- [**7365**星][1m] [Py] [s0md3v/xsstrike](https://github.com/s0md3v/XSStrike) Most advanced XSS scanner.
    - 重复区段: [工具->漏洞->XSS->未分类-XSS](#648e49b631ea4ba7c128b53764328c39) |
...
- [**3421**星][14d] [Perl] [sullo/nikto](https://github.com/sullo/nikto) Nikto web server scanner
- [**3184**星][7d] [Go] [mozilla/sops](https://github.com/mozilla/sops) Simple and flexible tool for managing secrets
- [**3180**星][14d] [Py] [maurosoria/dirsearch](https://github.com/maurosoria/dirsearch) Web path scanner
...
- [**2037**星][11d] [Py] [nabla-c0d3/sslyze](https://github.com/nabla-c0d3/sslyze) SSL/TLS服务器扫描
...
- [**564**星][5m] [Py] [codingo/vhostscan](https://github.com/codingo/vhostscan) A virtual host scanner that performs reverse lookups, can be used with pivot tools, detect catch-all scenarios, work around wildcards, aliases and dynamic default pages.
- [**551**星][7m] [Go] [marco-lancini/goscan](https://github.com/marco-lancini/goscan) Interactive Network Scanner
- [**538**星][4m] [Py] [cisagov/pshtt](https://github.com/cisagov/pshtt) Scan domains and return data based on HTTPS best practices
...
- [**304**星][19d] [PS] [canix1/adaclscanner](https://github.com/canix1/adaclscanner) Repo for ADACLScan.ps1 - Your number one script for ACL's in Active Directory
...
- [**276**星][20d] [Go] [zmap/zgrab2](https://github.com/zmap/zgrab2) Go Application Layer Scanner
...
- [**911**星][19d] [C#] [elevenpaths/foca](https://github.com/elevenpaths/foca) Tool to find metadata and hidden information in the documents.
...
- [**319**星][8d] [HTML] [tanjiti/sec_profile](https://github.com/tanjiti/sec_profile) 爬取secwiki和xuanwu.github.io/sec.today,分析安全信息站点、安全趋势、提取安全工作者账号(twitter,weixin,github等)
    - 重复区段: [工具->侦察->社交网络->Github](#8d1ae776898748b8249132e822f6c919) |
...
- [**1768**星][13d] [Shell] [leebaird/discover](https://github.com/leebaird/discover) 自定义的bash脚本, 用于自动化多个渗透测试任务, 包括: 侦查、扫描、解析、在Metasploit中创建恶意Payload和Listener
    - 重复区段: [工具->渗透->自动化](#fc8737aef0f59c3952d11749fe582dac) |[工具->渗透->Payload->Payload生成](#ad92f6b801a18934f1971e2512f5ae4f) |[工具->渗透->Metasploit->未分类-metasploit](#01be61d5bb9f6f7199208ff0fba86b5d) |
...
- [**1329**星][1m] [CSS] [undeadsec/socialfish](https://github.com/undeadsec/socialfish) 网络钓鱼培训与信息收集
    - 重复区段: [工具->社工(SET)->未分类-SET](#ce734598055ad3885d45d0b35d2bf0d7) |
...
- [**1270**星][1y] [PS] [dafthack/mailsniper](https://github.com/dafthack/mailsniper) 在Microsoft Exchange环境中搜索邮件中包含的指定内容：密码、insider intel、网络架构信息等
- [**1203**星][30d] [Py] [codingo/nosqlmap](https://github.com/codingo/NoSQLMap) Automated NoSQL database enumeration and web application exploitation tool.
    - 重复区段: [工具->漏洞->漏洞利用->漏洞利用](#c83f77f27ccf5f26c8b596979d7151c3) |[工具->数据库->NoSQL->未分类-NoSQL](#af0aaaf233cdff3a88d04556dc5871e0) |
...
- [**544**星][18d] [Py] [m4ll0k/infoga](https://github.com/m4ll0k/infoga) 邮件信息收集工具
- [**506**星][27d] [no-github/digital-privacy](https://github.com/no-github/digital-privacy) 一个关于数字隐私搜集、保护、清理集一体的方案,外加开源信息收集(OSINT)对抗
...
- [**230**星][9d] [TS] [ninoseki/mitaka](https://github.com/ninoseki/mitaka) A browser extension for OSINT search
...
- [**221**星][27d] [PS] [tonyphipps/meerkat](https://github.com/tonyphipps/meerkat) A collection of PowerShell modules designed for artifact gathering and reconnaisance of Windows-based endpoints.
...
- [**545**星][8m] [Py] [feeicn/esd](https://github.com/feeicn/esd) Enumeration sub domains(枚举子域名)
- [**486**星][15d] [Py] [typeerror/domained](https://github.com/TypeError/domained) Multi Tool Subdomain Enumeration
...
- [**3565**星][8d] [Shell] [drwetter/testssl.sh](https://github.com/drwetter/testssl.sh) 检查服务器任意端口对 TLS/SSL 的支持、协议以及一些加密缺陷，命令行工具
...
- [**268**星][8d] [Rust] [nccgroup/dirble](https://github.com/nccgroup/dirble) Fast directory scanning and scraping tool
- [**254**星][8d] [Java] [ripe-ncc/whois](https://github.com/ripe-ncc/whois) RIPE Database whois code repository


### <a id="016bb6bd00f1e0f8451f779fe09766db"></a>指纹&&Fingerprinting


- [**9064**星][28d] [JS] [valve/fingerprintjs2](https://github.com/valve/fingerprintjs2) Modern & flexible browser fingerprinting library
...
- [**319**星][8d] [HTML] [tanjiti/sec_profile](https://github.com/tanjiti/sec_profile) 爬取secwiki和xuanwu.github.io/sec.today,分析安全信息站点、安全趋势、提取安全工作者账号(twitter,weixin,github等)
    - 重复区段: [工具->扫描器->隐私](#58d8b993ffc34f7ded7f4a0077129eb2) |
...
- [**2350**星][2m] [Py] [ab77/netflix-proxy](https://github.com/ab77/netflix-proxy) Smart DNS proxy to watch Netflix
...
- [**247**星][8m] [Py] [dirkjanm/adidnsdump](https://github.com/dirkjanm/adidnsdump) Active Directory Integrated DNS dumping by any authenticated user
...
- [**851**星][3m] [Py] [649/memcrashed-ddos-exploit](https://github.com/649/memcrashed-ddos-exploit) DDoS attack tool for sending forged UDP packets to vulnerable Memcached servers obtained using Shodan API
    - 重复区段: [工具->渗透->DDOS](#a0897294e74a0863ea8b83d11994fad6) |
...
- [**952**星][1m] [PS] [netspi/powerupsql](https://github.com/netspi/powerupsql) 攻击SQL服务器的PowerShell工具箱
...
- [**527**星][5m] [Py] [quentinhardy/msdat](https://github.com/quentinhardy/msdat) Microsoft SQL Database Attacking Tool
- [**492**星][24d] [Go] [cossacklabs/acra](https://github.com/cossacklabs/acra) 数据库保护套件
...
- [**554**星][2m] [HTML] [netspi/sqlinjectionwiki](https://github.com/netspi/sqlinjectionwiki) A wiki focusing on aggregating and documenting various SQL injection methods
...
- [**1203**星][30d] [Py] [codingo/nosqlmap](https://github.com/codingo/NoSQLMap) Automated NoSQL database enumeration and web application exploitation tool.
    - 重复区段: [工具->侦察->未分类-OSINT](#05ab1b75266fddafc7195f5b395e4d99) |[工具->漏洞->漏洞利用->漏洞利用](#c83f77f27ccf5f26c8b596979d7151c3) |
...
- [**2767**星][2m] [Go] [kgretzky/evilginx2](https://github.com/kgretzky/evilginx2) 独立的MITM攻击工具，用于登录凭证钓鱼，可绕过双因素认证
    - 重复区段: [工具->浏览嗅探->中间人](#11c73d3e2f71f3914a3bca35ba90de36) |
- [**2105**星][1m] [Py] [elceef/dnstwist](https://github.com/elceef/dnstwist) 域名置换引擎，用于检测打字错误，网络钓鱼和企业间谍活动
    - 重复区段: [工具->侦察->DNS](#a695111d8e30d645354c414cb27b7843) |
...
- [**535**星][1m] [Py] [shellphish/driller](https://github.com/shellphish/driller) augmenting AFL with symbolic execution!
...
- [**523**星][3m] [Java] [1998lixin/hardwarecode](https://github.com/1998lixin/hardwarecode) 基于xposed 修改硬件信息
...
- [**2660**星][1y] [Py] [mame82/p4wnp1](https://github.com/mame82/p4wnp1) 基于Raspberry Pi Zero 或 Raspberry Pi Zero W 的USB攻击平台, 高度的可定制性
    - 重复区段: [工具->硬件设备->树莓派](#77c39a0ad266ad42ab8157ba4b3d874a) |
...
- [**757**星][1m] [Py] [snovvcrash/usbrip](https://github.com/snovvcrash/usbrip) Simple CLI forensics tool for tracking USB device artifacts (history of USB events) on GNU/Linux
    - 重复区段: [工具->事件响应->取证](#1fc5d3621bb13d878f337c8031396484) |
...
- [**2660**星][1y] [Py] [mame82/p4wnp1](https://github.com/mame82/p4wnp1) 基于Raspberry Pi Zero 或 Raspberry Pi Zero W 的USB攻击平台, 高度的可定制性
    - 重复区段: [工具->硬件设备->USB](#48c53d1304b1335d9addf45b959b7d8a) |
...
- [**247**星][24d] [Py] [tipam/pi3d](https://github.com/tipam/pi3d) Simple, yet powerful, 3D Python graphics library for beginners and school children running on the Raspberry Pi.
...
- [**515**星][20d] [Py] [schutzwerk/canalyzat0r](https://github.com/schutzwerk/canalyzat0r) Security analysis toolkit for proprietary car protocols
...
- [**1155**星][11m] [JS] [mame82/p4wnp1_aloa](https://github.com/mame82/p4wnp1_aloa) 将 Rapsberry Pi Zero W 转变成灵活的渗透平台
    - 重复区段: [工具->硬件设备->未分类-Hardware](#ff462a6d508ef20aa41052b1cc8ad044) |
...
- [**3109**星][2m] [PS] [fireeye/commando-vm](https://github.com/fireeye/commando-vm) Complete Mandiant Offensive VM (Commando VM), a fully customizable Windows-based pentesting virtual machine distribution. commandovm@fireeye.com
- [**1718**星][1m] [PS] [fireeye/flare-vm](https://github.com/fireeye/flare-vm) 火眼发布用于 Windows 恶意代码分析的虚拟机：FLARE VM
...
- [**565**星][2m] [C++] [bkerler/exploit_me](https://github.com/bkerler/exploit_me) 带洞的 ARMApp, 可用于漏洞开发练习
- [**529**星][5m] [PHP] [acmesec/dorabox](https://github.com/Acmesec/DoraBox) DoraBox - 基础Web漏洞训练靶场
...
- [**15627**星][8d] [C] [curl/curl](https://github.com/curl/curl) A command line tool and library for transferring data with URL syntax, supporting HTTP, HTTPS, FTP, FTPS, GOPHER, TFTP, SCP, SFTP, SMB, TELNET, DICT, LDAP, LDAPS, FILE, IMAP, SMTP, POP3, RTSP and RTMP. libcurl offers a myriad of powerful features
- [**11935**星][1m] [Go] [buger/goreplay](https://github.com/buger/goreplay) 实时捕获HTTP流量并输入测试环境，以便持续使用真实数据测试你的系统
- [**6557**星][12d] [Py] [networkx/networkx](https://github.com/networkx/networkx) 用于创建、操纵和研究复杂网络的结构，Python包
...
- [**1060**星][7m] [PS] [nytrorst/netripper](https://github.com/nytrorst/netripper) 后渗透工具,针对Windows, 使用API Hooking拦截网络流量和加密相关函数, 可捕获明文和加密前后的内容
...
- [**818**星][22d] [C] [emmericp/ixy](https://github.com/emmericp/ixy) Simple userspace packet processing for educational purposes
...
- [**562**星][29d] [PHP] [object-calisthenics/phpcs-calisthenics-rules](https://github.com/object-calisthenics/phpcs-calisthenics-rules) Object Calisthenics rules for PHP_CodeSniffer
- [**515**星][7m] [C++] [kohler/click](https://github.com/kohler/click) The Click modular router: fast modular packet processing and analysis
...
- [**348**星][10d] [TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) 
    - 重复区段: [工具->移动->Android](#fe88ee8c0df10870b44c2dedcd86d3d3) |[工具->浏览嗅探->中间人](#11c73d3e2f71f3914a3bca35ba90de36) |
...
- [**256**星][1m] [Py] [ghostop14/sparrow-wifi](https://github.com/ghostop14/sparrow-wifi) Next-Gen GUI-based WiFi and Bluetooth Analyzer for Linux
    - 重复区段: [工具->蓝牙](#ceb90405292daed9bb32ac20836c219a) |[工具->渗透->无线->未分类-WiFi](#d4efda1853b2cb0909727188116a2a8c) |
...
- [**16951**星][14d] [Py] [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - 重复区段: [工具->通信->未分类-Proxy](#56acb7c49c828d4715dce57410d490d1) |
...
- [**2851**星][11d] [JS] [evilsocket/pwnagotchi](https://github.com/evilsocket/pwnagotchi) 深度学习+Bettercap，基于A2C，从周围的WiFi环境中学习，以最大程度地利用捕获的WPA关键信息
    - 重复区段: [工具->人工智能->未分类-AI](#19dd474da6b715024ff44d27484d528a) |[工具->渗透->无线->未分类-WiFi](#d4efda1853b2cb0909727188116a2a8c) |
- [**2767**星][2m] [Go] [kgretzky/evilginx2](https://github.com/kgretzky/evilginx2) 独立的MITM攻击工具，用于登录凭证钓鱼，可绕过双因素认证
    - 重复区段: [工具->社工(SET)->钓鱼](#290e9ae48108d21d6d8b9ea9e74d077d) |
- [**1417**星][1m] [Py] [xdavidhu/mitmap](https://github.com/xdavidhu/mitmap) 
- [**1347**星][14d] [Go] [unrolled/secure](https://github.com/unrolled/secure) HTTP middleware for Go that facilitates some quick security wins.
...
- [**1031**星][4m] [PS] [kevin-robertson/inveigh](https://github.com/kevin-robertson/inveigh) Windows PowerShell ADIDNS/LLMNR/mDNS/NBNS spoofer/man-in-the-middle tool
...
- [**348**星][10d] [TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) 
    - 重复区段: [工具->移动->Android](#fe88ee8c0df10870b44c2dedcd86d3d3) |[工具->浏览嗅探->未分类-Network](#99398a5a8aaf99228829dadff48fb6a7) |
...
- [**1031**星][1y] [PS] [danmcinerney/icebreaker](https://github.com/danmcinerney/icebreaker) Gets plaintext Active Directory credentials if you're on the internal network but outside the AD environment
- [**997**星][5m] [Ruby] [mdp/rotp](https://github.com/mdp/rotp) Ruby One Time Password library
- [**899**星][11d] [C] [cossacklabs/themis](https://github.com/cossacklabs/themis) 用于存储或通信的加密库，可用于Swift, ObjC, Android, С++, JS, Python, Ruby, PHP, Go。
- [**739**星][20d] [Py] [ricterz/genpass](https://github.com/ricterz/genpass) 中国特色的弱口令生成器
- [**514**星][2m] [Py] [unode/firefox_decrypt](https://github.com/unode/firefox_decrypt) Firefox Decrypt is a tool to extract passwords from Mozilla (Firefox/Thunderbird/SeaMonkey) profiles
...
- [**486**星][1y] [PS] [dafthack/domainpasswordspray](https://github.com/dafthack/domainpasswordspray) DomainPasswordSpray is a tool written in PowerShell to perform a password spray attack against users of a domain. By default it will automatically generate the userlist from the domain. BE VERY CAREFUL NOT TO LOCKOUT ACCOUNTS!
...
- [**21751**星][7d] [PHP] [danielmiessler/seclists](https://github.com/danielmiessler/seclists) 多种类型资源收集：用户名、密码、URL、敏感数据类型、Fuzzing  Payload、WebShell等
    - 重复区段: [工具->wordlist->收集](#3202d8212db5699ea5e6021833bf3fa2) |[工具->渗透->Payload->Payload收集](#b5d99a78ddb383c208aae474fc2cb002) |
...
- [**7696**星][8d] [JS] [gchq/cyberchef](https://github.com/gchq/cyberchef) The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
...
- [**993**星][22d] [JS] [monzo/response](https://github.com/monzo/response) Monzo's real-time incident response and reporting tool
- [**781**星][1m] [microsoft/msrc-security-research](https://github.com/microsoft/msrc-security-research) Security Research from the Microsoft Security Response Center (MSRC)
- [**751**星][10m] [PS] [davehull/kansa](https://github.com/davehull/kansa) A Powershell incident response framework
...
- [**540**星][6m] [Py] [owasp/qrljacking](https://github.com/owasp/qrljacking) 一个简单的能够进行会话劫持的社会工程攻击向量，影响所有使用“使用 QR 码登录”作为安全登录方式的应用程序。（ Quick Response CodeLogin Jacking）
...
- [**204**星][2m] [PS] [wiredpulse/posh-r2](https://github.com/wiredpulse/posh-r2) PowerShell - Rapid Response... For the incident responder in you!


### <a id="1fc5d3621bb13d878f337c8031396484"></a>取证&&Forensics&&数字取证&&内存取证


- [**3326**星][14d] [Py] [google/grr](https://github.com/google/grr) remote live forensics for incident response
...
- [**1218**星][12d] [Py] [google/timesketch](https://github.com/google/timesketch) Collaborative forensic timeline analysis
...
- [**757**星][1m] [Py] [snovvcrash/usbrip](https://github.com/snovvcrash/usbrip) Simple CLI forensics tool for tracking USB device artifacts (history of USB events) on GNU/Linux
    - 重复区段: [工具->硬件设备->USB](#48c53d1304b1335d9addf45b959b7d8a) |
- [**543**星][20d] [Go] [biggiesmallsag/nighthawkresponse](https://github.com/biggiesmallsag/nighthawkresponse) Incident Response Forensic Framework
...
- [**1305**星][19d] [C] [dtag-dev-sec/tpotce](https://github.com/dtag-dev-sec/tpotce) 创建多蜜罐平台T-Pot ISO 镜像
- [**1235**星][1m] [Go] [hacklcx/hfish](https://github.com/hacklcx/hfish) 扩展企业安全测试主动诱导型开源蜜罐框架系统，记录黑客攻击手段
- [**1172**星][13d] [C] [the-tcpdump-group/tcpdump](https://github.com/the-tcpdump-group/tcpdump) the TCPdump network dissector
...
- [**224**星][8d] [Py] [jamesturk/django-honeypot](https://github.com/jamesturk/django-honeypot) 
...
- [**1869**星][14d] [YARA] [yara-rules/rules](https://github.com/yara-rules/rules) Repository of yara rules
...
- [**518**星][7m] [Py] [te-k/harpoon](https://github.com/te-k/harpoon) CLI tool for open source and threat intelligence
- [**449**星][5m] [PHP] [kasperskylab/klara](https://github.com/kasperskylab/klara) Kaspersky's GReAT KLara
- [**444**星][5m] [PS] [sans-blue-team/deepbluecli](https://github.com/sans-blue-team/deepbluecli) a PowerShell Module for Threat Hunting via Windows Event Logs
...
- [**371**星][19d] [zer0yu/cybersecurityrss](https://github.com/zer0yu/cybersecurityrss) RSS: 优秀的个人情报来源
...
- [**237**星][8d] [Py] [a13xp0p0v/kconfig-hardened-check](https://github.com/a13xp0p0v/kconfig-hardened-check) A script for checking the hardening options in the Linux kernel config
- [**217**星][15d] [Puppet] [dev-sec/puppet-os-hardening](https://github.com/dev-sec/puppet-os-hardening) This puppet module provides numerous security-related configurations, providing all-round base protection.
...
- [**547**星][7m] [Py] [s0md3v/blazy](https://github.com/s0md3v/Blazy) Blazy is a modern login bruteforcer which also tests for CSRF, Clickjacking, Cloudflare and WAF .
- [**532**星][2m] [Go] [janusec/janusec](https://github.com/janusec/janusec) Janusec Application Gateway, a Golang based application security solution which provides WAF (Web Application Firewall), CC attack defense, unified web administration portal, private key protection, web routing and scalable load balancing.
...
- [**205**星][22d] [Py] [stamparm/identywaf](https://github.com/stamparm/identywaf) Blind WAF identification tool
...
- [**3230**星][2m] [ObjC] [objective-see/lulu](https://github.com/objective-see/lulu) LuLu is the free macOS firewall
...
- [**552**星][6m] [Go] [sysdream/chashell](https://github.com/sysdream/chashell) Chashell is a Go reverse shell that communicates over DNS. It can be used to bypass firewalls or tightly restricted networks.
...
- [**564**星][25d] [Py] [0kee-team/watchad](https://github.com/0kee-team/watchad) AD Security Intrusion Detection System
...
- [**223**星][26d] [Py] [secureworks/dalton](https://github.com/secureworks/dalton) 使用预定义/指定的规则, 针对IDS传感器(例如Snort/Suricata)进行网络数据包捕获
...
- [**1693**星][8m] [Py] [guelfoweb/knock](https://github.com/guelfoweb/knock) 使用 Wordlist 枚举子域名
    - 重复区段: [工具->侦察->子域名枚举](#e945721056c78a53003e01c3d2f3b8fe) |
...
- [**21751**星][7d] [PHP] [danielmiessler/seclists](https://github.com/danielmiessler/seclists) 多种类型资源收集：用户名、密码、URL、敏感数据类型、Fuzzing  Payload、WebShell等
    - 重复区段: [工具->webshell->收集](#e08366dcf7aa021c6973d9e2a8944dff) |[工具->渗透->Payload->Payload收集](#b5d99a78ddb383c208aae474fc2cb002) |
...
- [**554**星][1y] [CSS] [hashview/hashview](https://github.com/hashview/hashview) 密码破解和分析工具
- [**543**星][2m] [Py] [pure-l0g1c/instagram](https://github.com/pure-l0g1c/instagram) Bruteforce attack for Instagram
- [**524**星][14d] [C] [nmap/ncrack](https://github.com/nmap/ncrack) Ncrack network authentication tool
- [**520**星][3m] [Py] [ypeleg/hungabunga](https://github.com/ypeleg/hungabunga) HungaBunga: Brute-Force all sklearn models with all parameters using .fit .predict!
...
- [**1857**星][7d] [olivierlaflamme/cheatsheet-god](https://github.com/olivierlaflamme/cheatsheet-god) Penetration Testing Reference Bank - OSCP / PTP & PTX Cheatsheet
    - 重复区段: [工具->收集->混合型收集](#664ff1dbdafefd7d856c88112948a65b) |
...
- [**676**星][12d] [XSLT] [adon90/pentest_compilation](https://github.com/adon90/pentest_compilation) Compilation of commands, tips and scripts that helped me throughout Vulnhub, Hackthebox, OSCP and real scenarios
    - 重复区段: [工具->收集->未分类](#e97d183e67fa3f530e7d0e7e8c33ee62) |
- [**422**星][7d] [PS] [mantvydasb/redteam-tactics-and-techniques](https://github.com/mantvydasb/RedTeam-Tactics-and-Techniques) Red Teaming Tactics and Techniques
...
- [**364**星][8m] [PS] [ferreirasc/oscp](https://github.com/ferreirasc/oscp) oscp study
...
- [**2660**星][7d] [PS] [redcanaryco/atomic-red-team](https://github.com/redcanaryco/atomic-red-team) Small and highly portable detection tests based on MITRE's ATT&CK.
- [**1342**星][7d] [Py] [mitre/caldera](https://github.com/mitre/caldera) 自动化 adversary emulation 系统
- [**562**星][6m] [HTML] [nshalabi/attack-tools](https://github.com/nshalabi/attack-tools) Utilities for MITRE™ ATT&CK
...
- [**256**星][1m] [Py] [ghostop14/sparrow-wifi](https://github.com/ghostop14/sparrow-wifi) Next-Gen GUI-based WiFi and Bluetooth Analyzer for Linux
    - 重复区段: [工具->浏览嗅探->未分类-Network](#99398a5a8aaf99228829dadff48fb6a7) |[工具->渗透->无线->未分类-WiFi](#d4efda1853b2cb0909727188116a2a8c) |
...
- [**2146**星][15d] [Java] [google/wycheproof](https://github.com/google/wycheproof) Project Wycheproof tests crypto libraries against known attacks.
